                    ...
                    <div className="_notifications_content">
                      ...
                      <div className="_notification_box_right">
                        <button
                          ...
                          onClick={(e) => { e.stopPropagation(); setNotifyMenuOpen((v) => !v); }}
                        >
                        ...
                        <div className={`_notifications_drop_right${notifyMenuOpen ? " show" : ""}`}>
              ...
              <div id="_prfoile_drop" className={`_nav_profile_dropdown _profile_dropdown${profileOpen ? " show" : ""}`}>
                <div className="_nav_profile_dropdown_info">
                  <div className="_nav_profile_dropdown_image">
                    <img src={user?.avatar ?? "/assets/images/profile.png"} alt="Profile" className="_nav_drop_img" />
                  </div>
                  <div className="_nav_profile_dropdown_info_txt">
                    <h4 className="_nav_dropdown_title">{fullName}</h4>
                    <span className="_nav_drop_profile" style={{ fontSize: "12px", color: "#666" }}>
                      {user?.email}
                    </span>
                  </div>
                </div>
